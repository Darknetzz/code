...
.\target\release\hash-zero.exe find --zeros 4 --unit hex
...
.\target\release\hash-zero.exe find --zeros 3 --char any --side any

# Legacy plain concatenation
.\target\release\hash-zero.exe find hello --zeros 4 --join concat
```
